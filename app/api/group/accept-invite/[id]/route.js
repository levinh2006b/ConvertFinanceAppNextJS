...
import { acceptInviteService } from '@/lib/group.service';
...
export async function POST(request, { params }) {
    try {
        ...
        const result = await acceptInviteService(inviteId, decoded.id);
        
        return NextResponse.json({ message: "Accept invite successfully", data: result }, { status: 200 });
    } catch (error) {
