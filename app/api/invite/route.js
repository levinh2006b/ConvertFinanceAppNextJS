...
import { getMyInvitesService } from '@/lib/group.service';
...
export async function GET(request) {
    try {
        ...
        // Gọi service lấy danh sách lời mời dựa vào ID của bạn
        const invites = await getMyInvitesService(decoded.id);
        
        return NextResponse.json({ message: "Get invites successfully", data: invites }, { status: 200 });
    } catch (error) {
