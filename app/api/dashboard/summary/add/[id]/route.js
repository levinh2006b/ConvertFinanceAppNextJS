...
import { getGroupAddSummaryService } from '@/lib/dashboard.service';
...
export async function GET(request, { params }) {
    try {
        ...
        const data = await getGroupAddSummaryService(groupId, period);
        return NextResponse.json({ message: "Get group add summary successfully", data: data }, { status: 200 });
    } catch (error) {
