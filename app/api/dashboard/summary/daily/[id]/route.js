...
import { getGroupDailySummaryService } from '@/lib/dashboard.service';
...
export async function GET(request, { params }) {
    try {
        ...
        const data = await getGroupDailySummaryService(groupId, period);
        return NextResponse.json({ message: "Get group daily summary successfully", data: data }, { status: 200 });
    } catch (error) {
